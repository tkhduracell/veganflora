import { contentHash as fnHash, embeddingText as fnText } from "../../functions/src/embedding.js"
import { contentHash as mcpHash, embeddingText as mcpText } from "../src/embedding-content.js"
...
const cases = [
	{ title: "Linssoppa", ingredients: [{ name: "röda linser" }, { name: "morot" }], text: "Koka." },
